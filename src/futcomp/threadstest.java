...
public class threadstest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        // A thread is a separate path of work.
        // This lets the program do more than one thing at the same time.
        ...
        // Do not use run() here. run() would act like a normal method call.
        workerOne.start();
        workerTwo.start();
